...
class Instance:
    ...
    def __init__(self, input: Sentence, output: List[str] = None, embedding = None, trigger_label = None, trigger_positions = None, trigger_key = None, entity_location_label = None) -> None:
        """
        ...
        self.entity_location_label = entity_location_label
